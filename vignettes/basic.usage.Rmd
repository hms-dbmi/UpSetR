...
Example 3: group by sets, how many intersections to show per group of sets
------------
Instead of the traditional method of grouping by degree, grouping by sets can be acheived using **group.by**. To set a cutoff for the number of intersections per group of sets use **cutoff**.
```{r, fig.width=12}
